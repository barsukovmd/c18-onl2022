 ...
 */
public class Main {
    //Если честно не понял вот эту строку
    // выбрасываете созданное ранее вами исключение и передаете его к месту откуда вызывали метод старт.
    //Я создал метод со своим исключением и передал в метод старт
